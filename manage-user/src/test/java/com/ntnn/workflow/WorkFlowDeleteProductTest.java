...
public class WorkFlowDeleteProductTest extends BaseTestTask {
    WorkFlowDeleteProduct workFlow;

    @Before
    public void init() {
        super.init();
        workFlow = new WorkFlowDeleteProduct("WorkFlowDeleteProduct", vertx);
    ...
    public void testUserNotFound(TestContext testContext) {
        ...
        suite.test("user aren't found", context -> {
            String str = "{\"resultCode\":200,\"result\":true,\"userId\":0,\"queue\":\"DELETE\",\"data\":{\"userReq\":{\"phoneNumber\":\"0939382121\"},\"productReq\":{\"id\":8,\"name\":\"Cococa Nata\",\"colorId\":3,\"price\":800,\"brandId\":1,\"description\":\"This is Cococa Conata\"}}}";
    ...
    public void testUserAccessDenied(TestContext testContext) {
        ...
        suite.test("user access deny", context -> {
            String str = "{\"resultCode\":200,\"result\":true,\"userId\":0,\"queue\":\"DELETE\",\"data\":{\"userReq\":{\"phoneNumber\":\"0939382799\"},\"productReq\":{\"id\":8,\"name\":\"Cococa Nata\",\"colorId\":3,\"price\":800,\"brandId\":1,\"description\":\"This is Cococa Conata\"}}}";
            TaskData taskData = new TaskData(str);
            workFlow.run(taskData, whenDone -> {
                log.info(whenDone);
                testContext.assertEquals(whenDone.getResult(), false);
    ...
    public void testUserInsertSuccess(TestContext testContext) {
        ...
        suite.test("user delete success", context -> {
            String str = "{\"resultCode\":200,\"result\":true,\"userId\":0,\"queue\":\"DELETE\",\"data\":{\"userReq\":{\"phoneNumber\":\"0939382758\"},\"productReq\":{\"id\":8,\"name\":\"Cococa Nata\",\"colorId\":3,\"price\":800,\"brandId\":1,\"description\":\"This is Cococa Conata\"}}}";
            TaskData taskData = new TaskData(str);
            workFlow.run(taskData, whenDone -> {
