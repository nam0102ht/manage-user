...
public class EmployeeTeamsDBTaskTest extends BaseTestTask {
    EmployeeTeamsDBTask task;
    @Before
    public void init() {
        super.init();
        task = new EmployeeTeamsDBTask("EmployeeTeamsDBTask", vertx);
    }
    @Test
